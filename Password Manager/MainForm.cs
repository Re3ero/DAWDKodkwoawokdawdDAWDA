...
namespace Password_Manager
{
    public partial class MainForm : Form
    {
        ...
        private void addButton_Click(object sender, EventArgs e)
        {
            ...
            if (string.IsNullOrEmpty(login) || string.IsNullOrEmpty(parola) || string.IsNullOrEmpty(site) || string.IsNullOrEmpty(notita))
            {
            ...
            // Сохранение данных в файл после добавления новой записи
        ...
        private void DelButton_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("Please choose an account you want to delete!", "Info", MessageBoxButtons.OK, MessageBoxIcon.Information);
                return;
            }
            ...
            if (res == DialogResult.Yes)
            {
                ...
                // Сохранение данных в файл после удаления записи
                ManagerParole.SalveazaParolele(ManagerParole.LocatieFisier, ManagerParole.MainPassword);
            }
        }
        ...
        private void ReplaceButton_Click(object sender, EventArgs e)
        {
            ...
            // Сохранение данных в файл после замены записи
            ManagerParole.SalveazaParolele(ManagerParole.LocatieFisier, ManagerParole.MainPassword);
        }
        ...
        {
            if (arataParola.Text == "Показать")
            {
                arataParola.Text = "Скрыть";
                passBox.UseSystemPasswordChar = false;
            }
            else
            {
                arataParola.Text = "Показать";
        ...
        {
            if (ascundeParole.Text == "  Показать пароли")
            {
                arata = true;
                ascundeParole.Text = "  Скрыть пароли";
            }
            else
            {
                arata = false;
                ascundeParole.Text = "  Показать пароли";
            }
            RefreshList(arata);

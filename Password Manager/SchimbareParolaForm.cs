...
namespace Password_Manager
{
    public partial class SchimbareParolaForm : Form
    {
        ...
        private void pwToggleButton_Click(object sender, EventArgs e)
        {
            ...
            {
                Toggle(false);
                pwToggleButton.Image = Password_Manager.Properties.Resources.dispari;
            }
            else
            {
                Toggle(true);
                pwToggleButton.Image = Password_Manager.Properties.Resources.apari;
            }
        }
        ...
        private void okButton_Click(object sender, EventArgs e)
        {
            if (NewPassBox.Text != CNewPassBox.Text)
                MessageBox.Show("The password is wrong in at least one field!", "Info", MessageBoxButtons.OK, MessageBoxIcon.Information);
            ...
            else
            {
                ...
                MessageBox.Show("Password was changed successfully!", "Info", MessageBoxButtons.OK, MessageBoxIcon.Information);
                this.Close();
            }
        }
    }
